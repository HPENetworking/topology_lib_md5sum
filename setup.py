...
setup(
    name='topology_lib_md5sum',
    version=find_version('lib/topology_lib_md5sum/__init__.py'),
    package_dir={'': 'lib'},
    ...
    url='git@github.com:maralas/md5sum.git/tree/master/doc',
    keywords='topology_lib_md5sum',
    ...
    entry_points={
        'topology_library_10': [
            'md5sum = topology_lib_md5sum.library'
        ]
    }
)
